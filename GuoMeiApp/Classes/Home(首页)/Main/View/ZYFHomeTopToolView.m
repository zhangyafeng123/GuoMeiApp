...
@implementation ZYFHomeTopToolView
...
- (void)layoutSubviews
{
    ...
    [_rightItemButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(weakSelf.leftItemButton.mas_centerY);
    ...
    [_topSearchView mas_makeConstraints:^(MASConstraintMaker *make) {
        [make.left.mas_equalTo(weakSelf.leftItemButton.mas_right)setOffset:5];
        [make.right.mas_equalTo(weakSelf.rightRItemButton.mas_left)setOffset:5];
        make.height.mas_equalTo(@(32));
        make.centerY.mas_equalTo(weakSelf.rightRItemButton);
    ...
    [_searchButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        [make.right.mas_equalTo(weakSelf.topSearchView)setOffset:-2*DCMargin];
    }];
    
    [_voiceButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.mas_equalTo(weakSelf.topSearchView);
        make.centerY.mas_equalTo(weakSelf.topSearchView);
