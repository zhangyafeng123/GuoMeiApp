...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[ZYFFeatureCell class] forCellWithReuseIdentifier:DCNewFeatureCellID];
    }
...
{
    ZYFFeatureCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:DCNewFeatureCellID forIndexPath:indexPath];
    ...
    cell.hideButtonClickBlock = ^{
        ...
        [weakSelf restoreRootViewController:[[ZYFTabBarController alloc] init]];
    };
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    if (scrollView.contentOffset.x >  (_imageArray.count - 1) * ScreenW) {
        [self restoreRootViewController:[[ZYFTabBarController alloc] init]];
    }
}
